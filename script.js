document.addEventListener('DOMContentLoaded', function() {
  ...
  const data = [
    ...
    ['https://007hyno.github.io/find-vac.github.io/', './utils/vaccination.png', 'Vaccination (Deprecated)', 'Find vacant Covid Vaccination slots near you','./utils/web.png','Web'],
    ['https://play.google.com/store/apps/details?id=com.paras.ssbprep', './utils/ssb.png', 'SSB Quest: SSB Prepration', 'Free SSB Prepration App 📚Mock Tests, ⌛Stopwatch, 📖Study Material: Articles & Videos.','./utils/android1.png','Android'],
  ];
